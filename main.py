...
def calculate_matching_percentage(file_path):
    ...
    try:
        ...
        df = pd.read_csv(file_path, delimiter=',', encoding='utf-8-sig', on_bad_lines='skip')
        ...
        # Explicitly cast the columns to string before stripping extra spaces
        ...
        if not mismatched_rows.empty:
            mismatched_rows.to_csv("mismatched_rows.csv", index=False, encoding='utf-8-sig')
